...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 18, 2023 at 08:19 PM
...
ALTER TABLE `attendance_table`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_attendence_students_key` (`st_id`);
...
ALTER TABLE `books`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_books_class_key` (`class`);
...
ALTER TABLE `exam`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_exam_class_key` (`class`);
...
ALTER TABLE `expenses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_teacher_expenses_key` (`te_id`);
...
ALTER TABLE `guide_teachers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_guide_teacher_key` (`te_id`),
  ADD KEY `fK_guide_students_key` (`st_id`);
...
ALTER TABLE `routine`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_routine_class_key` (`class`),
  ADD KEY `fK_routine_teacher_key` (`te_id`);
...
ALTER TABLE `students`
  ...
  ADD KEY `fK_students_class_key` (`class`);
...
ALTER TABLE `student_fees_collection`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fK_students_fees_key` (`st_id`);
...
--
ALTER TABLE `attendance_table`
  ADD CONSTRAINT `fK_attendence_students_key` FOREIGN KEY (`st_id`) REFERENCES `students` (`s_id`);

--
-- Constraints for table `books`
--
ALTER TABLE `books`
  ADD CONSTRAINT `fK_books_class_key` FOREIGN KEY (`class`) REFERENCES `class` (`c_id`);

--
-- Constraints for table `exam`
--
ALTER TABLE `exam`
  ADD CONSTRAINT `fK_exam_class_key` FOREIGN KEY (`class`) REFERENCES `students` (`s_id`);

--
-- Constraints for table `expenses`
--
ALTER TABLE `expenses`
  ADD CONSTRAINT `fK_teacher_expenses_key` FOREIGN KEY (`te_id`) REFERENCES `teachers` (`t_id`);

--
-- Constraints for table `guide_teachers`
--
ALTER TABLE `guide_teachers`
  ADD CONSTRAINT `fK_guide_students_key` FOREIGN KEY (`st_id`) REFERENCES `students` (`s_id`),
  ADD CONSTRAINT `fK_guide_teacher_key` FOREIGN KEY (`te_id`) REFERENCES `teachers` (`t_id`);

--
-- Constraints for table `routine`
--
ALTER TABLE `routine`
  ADD CONSTRAINT `fK_routine_class_key` FOREIGN KEY (`class`) REFERENCES `class` (`c_id`),
  ADD CONSTRAINT `fK_routine_teacher_key` FOREIGN KEY (`te_id`) REFERENCES `teachers` (`t_id`);

--
-- Constraints for table `students`
--
ALTER TABLE `students`
  ADD CONSTRAINT `fK_students_class_key` FOREIGN KEY (`class`) REFERENCES `class` (`c_id`);

--
-- Constraints for table `student_fees_collection`
--
ALTER TABLE `student_fees_collection`
  ADD CONSTRAINT `fK_students_fees_key` FOREIGN KEY (`st_id`) REFERENCES `students` (`s_id`);
COMMIT;
